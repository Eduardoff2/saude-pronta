        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#2ecc71] to-[#3498db] flex items-center justify-center shadow-lg">
                <svg
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-gray-100 hover:bg-[#2ecc71] flex items-center justify-center transition-colors duration-300 group"
              >
                <svg
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-xl bg-gray-100 hover:bg-[#3498db] flex items-center justify-center transition-colors duration-300 group"
              >
                <svg
                  className="w-5 h-5 text-gray-600 group-hover:text-white"
                  fill="currentColor"
            ...
            <ul className="space-y-2">
              {NAVIGATION.map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-gray-600 hover:text-[#2ecc71] transition-colors duration-200"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-gray-600">
                ...
                <span className="text-sm">contato@saudepronta.com</span>
              </li>
              <li className="flex items-center gap-2 text-gray-600">
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1 text-sm text-gray-600">
              Feito com <Heart className="w-4 h-4 text-red-500 fill-red-500" /> para sua saúde
            </div>
          </div>
        </div>
      </div>
